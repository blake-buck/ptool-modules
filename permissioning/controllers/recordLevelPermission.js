    ...
    const validQueryKeys = 'id,tableName,recordId,permissionType,granteeId,get,update,delete'.split(',');
    ...
    const getRecordLevelPermissionsSchema = Joi
        .object({
            ...
            fields: Joi.string().pattern(/^[\w+,*]+$/i).default('id,tableName,recordId,permissionType,granteeId,get,update,delete')
        })
        .pattern(
    ...
    const postRecordLevelPermissionSchema = Joi.object({tableName:Joi.string().required(),recordId:Joi.number().integer().required(),permissionType:Joi.string().required(),granteeId:Joi.string().required(),get:Joi.number().integer().required(),update:Joi.number().integer().required(),delete:Joi.number().integer().required()})
    ...
    const patchRecordLevelPermissionsSchema = Joi.array().items({id:Joi.number().integer().required(),tableName:Joi.string(),recordId:Joi.number().integer(),permissionType:Joi.string(),granteeId:Joi.string(),get:Joi.number().integer(),update:Joi.number().integer(),delete:Joi.number().integer()}) 
    ...
    const patchSpecificRecordLevelPermissionSchema = Joi.object({tableName:Joi.string(),recordId:Joi.number().integer(),permissionType:Joi.string(),granteeId:Joi.string(),get:Joi.number().integer(),update:Joi.number().integer(),delete:Joi.number().integer()})
