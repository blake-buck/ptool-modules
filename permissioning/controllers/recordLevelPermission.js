    ...
    const validQueryKeys = 'id,tableName,recordId,permissionType,get,update,delete'.split(',');
    ...
    const getRecordLevelPermissionsSchema = Joi
        .object({
            ...
            fields: Joi.string().pattern(/^[\w+,*]+$/i).default('id,tableName,recordId,permissionType,get,update,delete')
        })
        .pattern(
    ...
    const postRecordLevelPermissionSchema = Joi.object({tableName:Joi.string().required(),recordId:Joi.number().integer().required(),permissionType:Joi.string().required(),get:Joi.string().required(),update:Joi.string().required(),delete:Joi.string().required()})
    ...
    const updateRecordLevelPermissionsSchema = Joi.array().items({id:Joi.number().integer().required(),tableName:Joi.string().required(),recordId:Joi.number().integer().required(),permissionType:Joi.string().required(),get:Joi.string().required(),update:Joi.string().required(),delete:Joi.string().required()}) 
    ...
    const updateSpecificRecordLevelPermissionSchema = Joi.object({id:Joi.number().integer().required(),tableName:Joi.string().required(),recordId:Joi.number().integer().required(),permissionType:Joi.string().required(),get:Joi.string().required(),update:Joi.string().required(),delete:Joi.string().required()})
    ...
    const patchRecordLevelPermissionsSchema = Joi.array().items({id:Joi.number().integer().required(),tableName:Joi.string(),recordId:Joi.number().integer(),permissionType:Joi.string(),get:Joi.string(),update:Joi.string(),delete:Joi.string()}) 
    ...
    const patchSpecificRecordLevelPermissionSchema = Joi.object({tableName:Joi.string(),recordId:Joi.number().integer(),permissionType:Joi.string(),get:Joi.string(),update:Joi.string(),delete:Joi.string()})
