    ...
    describe('recordLevelPermission service tests', () => {
        it('getRecordLevelPermissions should return status 200 and two records', async (done) => {
            let response = await recordLevelPermissionServices.getRecordLevelPermissions({value: {limit:10, offset: 0, fields:'id,tableName,recordId,permissionType,granteeId,get,update,del'}});
        ...
        it('getSpecificRecordLevelPermission should return status 200 and a singular record', async (done) => {
            let response = await recordLevelPermissionServices.getSpecificRecordLevelPermission(1,'id,tableName,recordId,permissionType,granteeId,get,update,del');
            expect(response.status).toBe(200);
            expect(response.body).toBeTruthy();
        ...
        it('postRecordLevelPermission should return status 200 and an object with an id', async (done) => {
            let response = await recordLevelPermissionServices.postRecordLevelPermission({"tableName":"string","recordId":0,"permissionType":"string","granteeId":"string","get":0,"update":0,"del":0});
            expect(response.status).toBe(200);
            expect(response.body).toBeTruthy();
        ...
        it('updateRecordLevelPermissions should return status 200 and a body with a message property', async (done) => {
            let response = await recordLevelPermissionServices.updateRecordLevelPermissions([{"id":1,"tableName":"string","recordId":0,"permissionType":"string","granteeId":"string","get":0,"update":0,"del":0}]);
            expect(response.status).toBe(200);
            expect(response.body).toBeTruthy();
        ...
        it('updateSpecificRecordLevelPermission should return status 200 and a body with a message property', async (done) => {
            let response = await recordLevelPermissionServices.updateSpecificRecordLevelPermission({"id":1,"tableName":"string","recordId":0,"permissionType":"string","granteeId":"string","get":0,"update":0,"del":0});
            expect(response.status).toBe(200);
            expect(response.body).toBeTruthy();
            expect(response.body.message).toBeTruthy();
            done();
        ...
        it('patchRecordLevelPermissions should return status 200 and a body with a message property', async (done) => {
            let response = await recordLevelPermissionServices.patchRecordLevelPermissions([{"id":1,"tableName":"string","recordId":0,"permissionType":"string","granteeId":"string","get":0,"update":0,"del":0}]);
            expect(response.status).toBe(200);
            expect(response.body).toBeTruthy();
            expect(response.body.message).toBeTruthy();
            done();
        ...
        it('patchSpecificRecordLevelPermission should return status 200 and a body with a message property', async (done) => {
            let response = await recordLevelPermissionServices.patchSpecificRecordLevelPermission(1, {"tableName":"string","recordId":0,"permissionType":"string","granteeId":"string","get":0,"update":0,"del":0});
            expect(response.status).toBe(200);
            expect(response.body).toBeTruthy();
            expect(response.body.message).toBeTruthy();
            done();
