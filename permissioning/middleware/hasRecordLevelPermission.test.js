...
const hasRecordLevelPermission = require('./hasRecordLevelPermission');
...
describe('hasPermission middleware tests', () => {
    ...
    app.get(
        '/test/:id',
        hasRecordLevelPermission('testTable', 'get'),
        successHandler
    );

    app.put(
        '/test/:id',
        hasRecordLevelPermission('testTable', 'modify'),
        successHandler
    );
    ...
    app.delete(
        '/test/:id',
        hasRecordLevelPermission('testTable', 'del'),
        successHandler
    );
    ...
    it('if user has record-level-permission get permission they get access to route', async (done) => {
        request(app)
            .get('/api/v1/test/12345')
