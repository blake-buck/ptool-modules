    ...
    describe('recordLevelPermission routes tests ', () => {
        ...
        it('POST - /recordLevelPermission', async (done) => {
            request(app)
                ...
                .set('Accept', 'application/json')
                .send({"tableName":"string","recordId":0,"permissionType":"string","get":"string","update":"string","delete":"string"})
                .expect('Content-Type', /json/)
                .expect(200)
                .end(async (err, res) => {
                    if(err){
        ...
        it('PUT - /recordLevelPermission', async (done) => {
            request(app)
                ...
                .set('Accept', 'application/json')
                .send([{"id":1,"tableName":"string","recordId":0,"permissionType":"string","get":"string","update":"string","delete":"string"}])
                .expect('Content-Type', /json/)
                .expect(200)
                .end(async (err, res) => {
                    if(err){
